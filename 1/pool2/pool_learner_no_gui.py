...
class PoolGameModel(object):
    ...
    def __init__(self, player1, player2, table_width, table_height, ball_size, real_time=False):
        ...
        self.pool_simulator = pool_simulator.PoolSimulator(table_width, table_height, ball_size)
    ...
    def init_game(self):
        ...
        self.players[self.player_id].init(self.player_id,
                                          ...
                                          self.pool_simulator.get_pockets_position(), self.color_assignments)
...
#             print("Game Over ")
    ...
    def on_key_press(self, symbol, modifiers):
        if self.state == GameState.Wait:
            self.players[self.player_id].on_key_press(symbol, modifiers)