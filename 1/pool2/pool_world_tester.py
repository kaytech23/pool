...
class Main(pyglet.window.Window):
    ...
    def __init__(self):
        super(Main, self).__init__(1300, 700, vsync=False)
        ...
        self.world = pool2.pool_simulator.PoolSimulator()
        balls = self.world.generate_random_balls()
        self.world.set_balls(0, balls)
    ...
    def calculate_line(self):
        cue_position = self.world.get_cueball_position()
